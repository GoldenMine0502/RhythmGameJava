...
public class ImageUtility {
    ...
    public static int getResizedScalePoint(int location, int imageSize, double scale) {
        ...
        return (int) (location * 1D / scale + imageSize * 1D / scale / 2D - imageSize/2D);
    }
    ...
    public static BufferedImage createImageFromText(Font font, String text, Color color) {
        ...
        BufferedImage image = new BufferedImage(size.getX() + len, (int) ((double)size.getY()*1.25), BufferedImage.TYPE_INT_ARGB);
        ...
        g.drawString(text, len/2, size.getY());
